...
#import "BSHBalancedFlowLayout.h"
#import "BSHLinearPartition.h"

@interface BSHBalancedFlowLayout ()
{
...
@implementation BSHBalancedFlowLayout
...
- (void)prepareLayout
{
    ...
    NSAssert([self.delegate conformsToProtocol:@protocol(BSHBalancedFlowLayoutDelegate)], @"UICollectionView delegate should conform to BalancedFlowLayout protocol");
...
- (id<BSHBalancedFlowLayoutDelegate>)delegate
{
    return (id<BSHBalancedFlowLayoutDelegate>)self.collectionView.delegate;
}
...
- (CGSize)referenceSizeForHeaderInSection:(NSInteger)section
{
    ...
    if (respondsToSelector) {
        return [(id <BSHBalancedFlowLayoutDelegate>)self.collectionView.delegate collectionView:self.collectionView layout:self referenceSizeForHeaderInSection:section];
    }
...
- (CGSize)referenceSizeForFooterInSection:(NSInteger)section
{
    ...
    if (respondsToSelector) {
        return [(id <BSHBalancedFlowLayoutDelegate>)self.collectionView.delegate collectionView:self.collectionView layout:self referenceSizeForFooterInSection:section];
    }
