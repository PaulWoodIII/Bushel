...
@implementation BSHPlaceholderView

- (instancetype)initWithFrame:(CGRect)frame
{
    NSAssert(NO, @"-[BSHPlaceholderView initWithFrame:] will not return a usable view");
    return nil;
}
...
@interface BSHCollectionPlaceholderView ()
@property (nonatomic, strong) UIActivityIndicatorView *activityIndicatorView;
@property (nonatomic, strong, readwrite) BSHPlaceholderView *placeholderView;
@end

@implementation BSHCollectionPlaceholderView
...
{
    BSHPlaceholderView *placeholderView = _placeholderView;
...
{
    BSHPlaceholderView *oldPlaceHolder = self.placeholderView;
    ...
    self.placeholderView = [[BSHPlaceholderView alloc] initWithFrame:CGRectZero title:title message:message image:image buttonTitle:nil buttonAction:nil];
...
@interface BSHPlaceholderCell ()
@property (nonatomic, strong, readwrite) BSHPlaceholderView *placeholderView;
@end

@implementation BSHPlaceholderCell
