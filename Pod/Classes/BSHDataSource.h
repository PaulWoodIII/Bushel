...
typedef enum {
	BSHDataSourceSectionOperationDirectionNone,
	BSHDataSourceSectionOperationDirectionRight,
	BSHDataSourceSectionOperationDirectionLeft
} BSHDataSourceSectionOperationDirection;

@interface BSHDataSource : NSObject <UICollectionViewDataSource, BSHContentLoading>
...
@property (nonatomic, strong) BSHLayoutSectionMetrics *defaultMetrics;

- (BSHLayoutSectionMetrics *)metricsForSectionAtIndex:(NSInteger)sectionIndex;
- (void)setMetrics:(BSHLayoutSectionMetrics *)metrics forSectionAtIndex:(NSInteger)sectionIndex __unused;
...
- (void)replaceHeaderForKey:(NSString *)key withHeader:(BSHLayoutSupplementaryMetrics *)header __unused;
