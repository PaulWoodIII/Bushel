...
@implementation BSHBasicDataSource
...
- (void)updateLoadingStateFromItems
{
    ...
    if (numberOfItems && [loadingState isEqualToString:BSHLoadStateNoContent])
        self.loadingState = BSHLoadStateContentLoaded;
    else if (!numberOfItems && [loadingState isEqualToString:BSHLoadStateContentLoaded])
        self.loadingState = BSHLoadStateNoContent;
}
