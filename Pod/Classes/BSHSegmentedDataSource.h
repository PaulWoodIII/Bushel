...
@interface BSHSegmentedDataSource : BSHDataSource
...
@property (nonatomic, readonly) BSHLayoutSupplementaryMetrics *segmentedControlHeader;
...
@property (nonatomic, strong) BSHDataSource *selectedDataSource;
