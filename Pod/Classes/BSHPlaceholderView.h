...
@interface BSHPlaceholderView : UIView
...
@interface BSHCollectionPlaceholderView : UICollectionReusableView

@property (nonatomic, strong, readonly) BSHPlaceholderView *placeholderView;
...
@interface BSHPlaceholderCell : UICollectionViewCell
