...
@implementation BSHComposedMapping
...
{
    BSHComposedMapping *result = [[BSHComposedMapping allocWithZone:zone] init];
...
@implementation BSHComposedCollectionView
